...
`VLC media player <https://videolan.org>`_ (commonly called VLC) is a free and open source cross-platform multimedia player and framework developed by the VideoLAN project. It is available for desktop operating systems and mobile platforms, such as Android, iOS, iPadOS, Tizen, Windows Phone. VLC supports many audio and video compression methods and file formats, including DVD-Video, video CD, and various streaming protocols.
...
To get the most out of the VLC media player, start by reviewing a few introductory topics
      ...
      * :ref:`Features <features>`: Introduction to the UI, commands, and features of the VLC media player.
